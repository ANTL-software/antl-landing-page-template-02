...
export const danceStudioSite: DanceStudioSite = {
  ...
  hero: { title: "Trouve ton\nélan.", cta: { label: "Réserver un cours", href: "#reserve" }, image: { src: danceHeroImage, alt: "Danseuse contemporaine sur une scène illuminée", position: "center top" } },
  ...
  founders: { eyebrow: "Les fondatrices", quote: "« La danse commence là où l'on ose prendre de la place. »", people: [{ name: "Sophia Bennett", role: "Fondatrice & professeure", panel: "left", image: { src: danceFoundersImage, alt: "Portrait de Sophia Bennett" } }, { name: "Alisa Morris", role: "Direction pédagogique", panel: "right", image: { src: danceFoundersImage, alt: "Portrait de Alisa Morris" } }] },
