...
export const danceStudioSite: DanceStudioSite = {
  ...
  vision: { eyebrow: "Notre vision", title: "Un espace pour bouger, créer et recommencer.", text: "Mouvement Studio réunit débutants, interprètes et curieux autour d'une pratique exigeante, bienveillante et profondément vivante.", cta: { label: "Découvrir le studio", href: "#fondateurs" } },
  ...
  founders: { eyebrow: "Les fondatrices", quote: "« La danse commence là où l'on ose prendre de la place. »", people: [{ name: "Sophia Bennett", role: "Fondatrice & professeure", crop: "top" }, { name: "Alisa Morris", role: "Direction pédagogique", crop: "center" }] },
